...
import { useGetUserProfile, useDeletePost, useCheckVerificationStatus, useIsCallerAdmin } from '../../hooks/useQueries';
...
export default function PostItem({ post }: PostItemProps) {
  ...
  const { data: isVerified } = useCheckVerificationStatus(post.authorPrincipal);
  ...
  const canDelete = isAuthor || isCallerAdmin;
            ...
            <ProfilePopover userPrincipal={post.authorPrincipal} displayName={displayName}>
              <button className="hover:underline text-left">
                <ModeratorVisualTreatment
                  ...
                  userPrincipal={post.authorPrincipal}
                  showLabel={false}
                />
              </button>
            </ProfilePopover>
